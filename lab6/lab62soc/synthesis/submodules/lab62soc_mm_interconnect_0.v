...
module lab62soc_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> reset_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // reset_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [16:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> reset_s1_agent:cp_channel
	...
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> spi_port_periperal_spi_control_port_agent:cp_valid
	wire  [107:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> spi_port_periperal_spi_control_port_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // spi_port_periperal_spi_control_port_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [16:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> spi_port_periperal_spi_control_port_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> spi_port_periperal_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> spi_port_periperal_spi_control_port_agent:cp_endofpacket
	...
	wire  [107:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_007:sink_data
	...
	wire          spi_port_periperal_spi_control_port_agent_rp_valid;                                 // spi_port_periperal_spi_control_port_agent:rp_valid -> router_018:sink_valid
	wire  [107:0] spi_port_periperal_spi_control_port_agent_rp_data;                                  // spi_port_periperal_spi_control_port_agent:rp_data -> router_018:sink_data
	wire          spi_port_periperal_spi_control_port_agent_rp_ready;                                 // router_018:sink_ready -> spi_port_periperal_spi_control_port_agent:rp_ready
	wire          spi_port_periperal_spi_control_port_agent_rp_startofpacket;                         // spi_port_periperal_spi_control_port_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          spi_port_periperal_spi_control_port_agent_rp_endofpacket;                           // spi_port_periperal_spi_control_port_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          spi_port_periperal_spi_control_port_agent_rdata_fifo_src_valid;                     // spi_port_periperal_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] spi_port_periperal_spi_control_port_agent_rdata_fifo_src_data;                      // spi_port_periperal_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          spi_port_periperal_spi_control_port_agent_rdata_fifo_src_ready;                     // avalon_st_adapter_016:in_0_ready -> spi_port_periperal_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> spi_port_periperal_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> spi_port_periperal_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // spi_port_periperal_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> spi_port_periperal_spi_control_port_agent:rdata_fifo_sink_error
